...
import type { AssistantConnectionListProjection, AssistantConnectionProjection } from "../../application/assistant/assistant-connection";
...
import type { AssistantSettingReviewResult } from "../../application/assistant/assistant-setting-review";
...
import type { CharacterExtractionCandidateList, CharacterExtractionDecisionResult, CharacterExtractionResult } from "../../application/characters/character-extraction-contract";
import type { CharacterGenerationCandidateList, CharacterGenerationDecisionResult, CharacterGenerationResult } from "../../application/characters/character-generation-contract";
...
import type { ExportManuscriptTextCommand, ManuscriptPreflightSettingsProjection } from "../../application/editor/manuscript-preflight";
...
import type { ForeshadowPointListProjection, ForeshadowPointProjection } from "../../application/foreshadowing/foreshadow-point-contract";
import type { FragmentListProjection, FragmentProjection } from "../../application/fragments/fragment-contract";
...
import type { PublishingAssistantApprovalResult, PublishingAssistantResult } from "../../application/publishing/publishing-assistant-contract";
...
import type { PublishingMailConnectionProjection, PublishingMailSyncResult } from "../../application/publishing/publishing-mail-connection-contract";
...
import type { AppSettingsProjection } from "../../application/settings/app-settings";
...
import type { PrepareSceneDraftInsertionResult, RunSceneDraftResult, SceneDraftCandidate, SceneDraftCandidateList } from "../../application/structure/scene-draft-contract";
import type { SceneExtractionAnnotationDecisionResult, SceneExtractionCandidateList, SceneExtractionDecisionResult, SceneExtractionResult } from "../../application/structure/scene-extraction-contract";
...
export type ApplicationRuntime = {
  ...
  createBackupBundle(bundlePath: string, mode?: LocalWorkspaceBackupMode): Promise<LocalWorkspaceBackupSummary>;
  restoreBackupBundle(
    bundlePath: string,
    targetPath: string,
